...
public class DestinationVoteConfigService {
    ...
    public VoteConfigResponse getConfig(UUID tripId, String deviceId) {
        ...
        return configRepository.findById(tripId)
                .map(c -> VoteConfigResponse.builder()
                        .tripId(c.getTripId())
                        .mode(c.getMode())
                        .updatedAt(c.getUpdatedAt())
                        .build())
                .orElse(VoteConfigResponse.builder()
                        .tripId(tripId)
    ...
    public VoteConfigResponse upsertConfig(UUID tripId, String deviceId, VoteMode newMode) {
        ...
        DestinationVoteConfig config = configRepository.findById(tripId)
